...
const ENVS = [
  { id: 'e1', projectId: 'p1', name: '测试', type: 'TEST', deployMode: 'local', externalPort: 8080, domain: '', status: 'active', enabled: true, autoDeploy: false },
  { id: 'e2', projectId: 'p1', name: '生产', type: 'PRODUCTION', deployMode: 'local', externalPort: 443, domain: 'app.example.com', status: 'active', enabled: true, autoDeploy: false },
  { id: 'e3', projectId: 'p2', name: 'Staging', type: 'STAGING', deployMode: 'local', externalPort: 8081, domain: '', status: 'inactive', enabled: true, autoDeploy: false },
]
