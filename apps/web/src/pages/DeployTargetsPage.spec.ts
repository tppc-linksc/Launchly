...
const TARGETS = [
  { id: 't1', projectId: 'p1', projectName: 'App', name: 'prod-a', type: 'SSH', host: '10.0.0.1', port: 22, username: 'deploy', workRoot: '/var/lib/launchly', authMethod: 'KEY', status: 'VERIFIED', lastVerifiedAt: '2026-01-01', hostKey: 'ssh-ed25519 AAAA' },
  { id: 't2', projectId: 'p2', projectName: 'Site', name: 'staging-b', type: 'SSH', host: '10.0.0.2', port: 2222, username: 'deploy', workRoot: '/var/lib/launchly', authMethod: 'KEY', status: 'FAILED', lastVerifiedAt: null, hostKey: 'ssh-ed25519 BBBB' },
]
