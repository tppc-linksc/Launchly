...
const RELEASE_READY = {
  id: 'r1', projectId: 'p1', version: '1.0.0', status: 'READY',
  gateStatus: 'PASSED', environmentId: 'e1', deploymentId: 'd1',
  releasedBy: null, releasedAt: null, createdAt: '2026-01-01', notes: 'note',
}
