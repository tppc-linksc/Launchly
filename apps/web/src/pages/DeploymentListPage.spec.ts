...
const DEPLOYMENT_LIST = [
  { id: 'd1', projectId: 'p1', environmentId: 'e1', branch: 'main', status: 'FAILED', commitSha: 'abc', deployTargetId: 't1', triggeredByName: 'Alice', createdAt: '2026-01-01' },
  { id: 'd2', projectId: 'p2', environmentId: 'e1', branch: 'develop', status: 'SUCCEEDED', commitSha: 'def', triggeredByName: null, createdAt: '2026-01-02' },
  { id: 'd3', projectId: 'p3', environmentId: 'e1', branch: 'feature', status: 'CANCELED', commitSha: null, triggeredBy: 'Bob', createdAt: '2026-01-03' },
]
