...
const RUN = {
  id: 'tr1', projectId: 'p1', deploymentId: 'd1', environmentId: 'e1',
  status: 'RUNNING', createdAt: '2026-01-01', finishedAt: null,
}

const CASES = [
  { id: 'trc1', testCaseId: 'tc-1', result: 'PENDING', notes: '', executedBy: null, executedAt: null, projectId: 'p1' },
  { id: 'trc2', testCaseId: 'tc-2', result: 'FAILED', notes: 'broken', executedBy: 'alice', executedAt: '2026-01-02', projectId: 'p1' },
]
