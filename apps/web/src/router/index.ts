  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'issues/:id', name: 'issue-detail', component: () => import('../pages/IssueDetailPage.vue') },
        { path: 'releases', name: 'releases', component: () => import('../pages/ReleaseListPage.vue') },
        { path: 'releases/:id', name: 'release-detail', component: () => import('../pages/ReleaseDetailPage.vue') },
