...
export function createOwner(data: { account: string; password: string; displayName?: string; workspaceName: string }) {
...
export function createIssueFromFailedTest(
  projectId: string,
  testRunCaseId: string,
  deploymentId: string,
  testCaseTitle?: string,
) {
  return api.post(`/projects/${projectId}/issues/from-failed-test`, null, {
    params: { testRunCaseId, deploymentId, testCaseTitle },
  });
}
